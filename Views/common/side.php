<div class="side">
            <div class="side-inner">
                <ul class="nav flex-column">
                    ...
                    <li class="nav item my-icon" ><img src="<?PHP echo htmlspecialchars($view_user['image_path']); ?>" class="js-popover" data-bs-container="body" data-bs-togale="popover" data-bs-placement="right"
