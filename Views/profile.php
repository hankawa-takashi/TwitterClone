    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="profile-area">
                <div class="top">
                    <div class="user"><img src="<?php echo buildImagePath($view_requested_user['image_name'], 'user'); ?>" alt="自分の画面"></div>
                    ...
                    <?php if ($view_user['id'] !== $view_requested_user['id']): ?>
                        ...
                        <?php else : ?>
                            <button class="btn btn-sm btn-reverse js-follow" data-follow-user-id="<?php echo $view_requested_user['id']; ?> ">フォローする</button>
                        <?php endif; ?>
                    <?php else: ?>
                        <!--自分のプロフィール -->
